  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        <h1 className="text-3xl font-extrabold text-gray-800 tracking-wide flex items-center">
          <Image
            src="/favicon.ico"
            alt="Nilesh Kumar"
            width={50}
            height={50}
            className="rounded-full border-1 shadow-lg border-purple-500"
          />
          <p className="ml-2 [text-shadow:_0_4px_4px_rgb(99_102_241_/_0.8)] text-purple-600 text-xl md:text-2xl leading-snug font-manrope font-extrabold">MovieFinder</p>
        </h1>
